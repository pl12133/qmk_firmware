 ...
 * |      |      |      |      |      |      |-------|    |-------|      |   1  |   2  |   3  |      |   |  |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | LGUI |LOWER | /Space  /       \Enter \  |Space |BackSP|  0   |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
[_LOWER] = LAYOUT(
  ...
  KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   _______, KC_4,    KC_5,    KC_6,    _______, _______,
  _______, _______, _______, _______, _______, _______, KC_LPRN, KC_RPRN, _______, KC_1,    KC_2,    KC_3,    _______, KC_PIPE,
                             _______, _______, _______, _______, _______, KC_SPC,  _______, KC_0
),
/* RAISE
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | LGUI |LOWER | /Space  /       \Enter \  |WKMAN |BackSP| RCTL |
 *                   |      |      |ESC   |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 [_WORKMAN] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_M,    KC_C,    KC_V, KC_LBRC,  KC_RBRC,  KC_K,    KC_L,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                          KC_LALT,    KC_LGUI, LOWER, KC_SPC,  KC_ENT,   WKMAN,   KC_BSPC, KC_RCTL
),
};
